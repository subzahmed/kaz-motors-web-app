...
export default function CarDetailPage({ params }: { params: { id: string } }) {
  // In a real application, you would fetch the car details based on the ID
  ...
  const car = {
    ...
    description:
      "Experience luxury and performance with this stunning 2023 Mercedes-Benz S-Class. This vehicle combines elegant design with cutting-edge technology to deliver an exceptional driving experience. The powerful 4.0L V8 Biturbo engine provides impressive acceleration while maintaining fuel efficiency. Inside, you'll find premium Nappa leather seats, a state-of-the-art MBUX infotainment system, and a Burmester 3D surround sound system for an immersive audio experience.",
  }
    ...
    <div className="container mx-auto py-12 px-4">
      ...
      <Tabs defaultValue="details">
        ...
        <TabsContent value="details" className="p-6 bg-gray-50 rounded-lg mt-4">
          ...
          <p>
            This vehicle comes with a comprehensive warranty package and has been thoroughly inspected by our certified
            technicians to ensure it meets our high standards of quality and performance.
          </p>
        </TabsContent>
